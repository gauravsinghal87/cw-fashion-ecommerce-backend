...
const { vendorRegisterValidator } = require('./validators');
const {
  registerVendor,
  loginVendor,
  getVendorProfile,
  ...
  getVendorDashboard,
  getVendorReturns,
} = require('../vendors/vendorController');
const {
...
} = require('../inventory/inventoryController');
const {
...
const { requestWithdrawal, getMyWithdrawals, getWalletInfo } = require('../withdrawals/withdrawalController');
