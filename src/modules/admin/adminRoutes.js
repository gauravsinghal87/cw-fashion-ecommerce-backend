...
const { couponValidator, categoryValidator, brandValidator } = require('./validators');
const {
...
const { approveWithdrawal, rejectWithdrawal, holdWithdrawal } = require('../withdrawals/withdrawalController');
const { getCouponAnalytics } = require('../coupons/couponController');
const { reverseReferralReward } = require('../referrals/referralController');
const { releaseSettlements, getAllSettlements } = require('../settlements/settlementController');
const { settleOrder, adminDownloadInvoice } = require('../orders/orderController');
const { createCMSPage } = require('../cms/cmsController');
const { getFooterSettings, updateFooterSettings } = require('../footer/footerController');
const {
...
} = require('../returns/returnController');
const { createBanner: bannerCreate, updateBanner: bannerUpdate, deleteBanner: bannerDelete } = require('../banners/bannerController');
...
router.get('/footer', ...a, checkPermission('settings', 'view'), getFooterSettings);
router.put('/footer', ...a, checkPermission('settings', 'manage'), updateFooterSettings);
